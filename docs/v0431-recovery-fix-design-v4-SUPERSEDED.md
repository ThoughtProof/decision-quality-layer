# v0.4.3.1 CB Recovery Fix — Design Draft v4 (SUPERSEDED)

> **SUPERSEDED by v5** — Hermes-Review 2026-07-11 zeigte: der behauptete Router-Kadenz-Bug
> existiert nicht. HttpLlmClient.call() ruft canProceed() bei jeder Achse. Gate-Architektur
> nach v4-Review auf zwei Gates (Model-Quality via disableCircuitBreaker + Runtime-Resilience
> auf realer Prod-Config). Kein soft-OPEN, keine neue State-Machine.
> Client-Level Regressionstest (llm-client.recovery-regression.test.ts) beweist bestehende
> HALF_OPEN-Recovery auf aktuellem Code grün. **Nicht zur Implementierung.** Siehe v5.

**Status**: SUPERSEDED
**Iteration**: v4 (v3 SUPERSEDED — Hermes-Review 2026-07-11 v4-Runde)
**Supersedes**: v3 und v2
